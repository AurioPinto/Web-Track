    ...
    <header class="header-global">
        <base-nav class="navbar-main" transparent type="" effect="light" expand>
            <router-link slot="brand" class="navbar-brand mr-lg-5" to="/">
                <img src="img/brand/pw.shanghai.jpg" alt="logo">
            </router-link>
            <div class="row" slot="content-header" slot-scope="{closeMenu}">
                <div class="col-6 collapse-brand">
                    <a href="https://demos.creative-tim.com/vue-argon-design-system/documentation/">
                        <img src="img/brand/pw.shanghai.jpg">
                    </a>
                </div>
            ...
            <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                ...
                <base-dropdown tag="li" class="nav-item">
                    ...
                    <router-link to="/landing" class="dropdown-item">Services</router-link>
                    <router-link to="/profile" class="dropdown-item">Offer</router-link>
                    <router-link to="/login" class="dropdown-item">About Us</router-link>
            ...
            <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://www.instagram.com/pwpwpw0"
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://twitter.com/PintoWest1" target="_blank" rel="noopener"
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://github.com/AurioPinto"
